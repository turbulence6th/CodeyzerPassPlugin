export default {
    ...
    "anaEkran.rehber.#6.baslik": "Refresh",
    "anaEkran.rehber.#6.aciklama": "If you update your passwords at another environment, you can refresh by this button.",
    "anaEkran.rehber.#7.baslik": "Platform name",
    "anaEkran.rehber.#7.aciklama": "Current page comes here when you add new password.",
    "anaEkran.rehber.#8.baslik": "Android application",
    "anaEkran.rehber.#8.aciklama": "Android application that you matched is showed here.",
    "anaEkran.rehber.#9.baslik": "Android package selector",
    "anaEkran.rehber.#9.aciklama": "Match your current password with android application here.",
    "anaEkran.rehber.#10.baslik": "Username box",
    "anaEkran.rehber.#10.aciklama": "Fill your username of related account.",
    "anaEkran.rehber.#11.baslik": "Şifre kutusu",
    "anaEkran.rehber.#11.aciklama": "Fill your password of related account.",
    "anaEkran.rehber.#12.baslik": "Add password button",
    "anaEkran.rehber.#12.aciklama": "You may add password by clicking add password button.",
    "anaEkran.rehber.#13.baslik": "Reseting form",
    "anaEkran.rehber.#13.aciklama": "You can empty all boxes by clicking reset button. It does not delete your saved password, only empties boxes at the screen.",
    "anaEkran.rehber.#14.baslik": "Changing main password box",
    "anaEkran.rehber.#14.aciklama": "Fill your new password to change your main password.",
    "anaEkran.rehber.#15.baslik": "Change password box",
    "anaEkran.rehber.#15.aciklama": "It updates your main password when you click the change password button.",
    "anaEkran.rehber.#16.baslik": "Logout button",
    "anaEkran.rehber.#16.aciklama": "You may finish your session by logout button.",
